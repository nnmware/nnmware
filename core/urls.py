...
urlpatterns = patterns('',
    ### Comments ###
    #    url(r'^comment/(?P<content_type>\d+)/(?P<object_id>\d+)/(?P<parent_id>\d+)/$', JCommentAdd.as_view(), name="jcomment_parent_add"),
    url(r'^comment/(?P<content_type>\d+)/(?P<object_id>\d+)/add/$', JCommentAdd.as_view(), name="jcomment_add"),
    url(r'^comment/(?P<content_type>\d+)/(?P<object_id>\d+)/(?P<parent_id>\d+)/$', JCommentAdd.as_view(),
        name="jcomment_parent_add"),
    url(r'^comment/edit/(?P<pk>[0-9]+)/$', JCommentEdit.as_view(), name="jcomment_edit"),
    url(r'^comment/edit_editor/(?P<pk>[0-9]+)/$', JCommentEditorEdit.as_view(), name="jcomment_edit_editor"),
    url(r'^comment/edit_admin/(?P<pk>[0-9]+)/$', JCommentAdminEdit.as_view(), name="jcomment_edit_admin"),
    url(r'^comment/status/(?P<pk>[0-9]+)/$', JCommentStatus.as_view(), name="jcomment_status"),
    url(r'^comment/status_editor/(?P<pk>[0-9]+)/$', JCommentEditorStatus.as_view(), name="jcomment_status_editor"),
    url(r'^comment/status_admin/(?P<pk>[0-9]+)/$', JCommentAdminStatus.as_view(), name="jcomment_status_admin"),
