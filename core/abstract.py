...
class AbstractWorkTime(models.Model):
    ...
    mon_to_any = models.BooleanField(verbose_name=_('Monday time to any'), default=False)
    ...
    tue_to_any = models.BooleanField(verbose_name=_('Tuesday time to any'), default=False)
    ...
    wed_to_any = models.BooleanField(verbose_name=_('Wednesday time to any'), default=False)
    ...
    thu_to_any = models.BooleanField(verbose_name=_('Thursday time to any'), default=False)
    ...
    fri_to_any = models.BooleanField(verbose_name=_('Friday time to any'), default=False)
    ...
    sat_to_any = models.BooleanField(verbose_name=_('Saturday time to any'), default=False)
    ...
    sun_to_any = models.BooleanField(verbose_name=_('Sunday time to any'), default=False)
