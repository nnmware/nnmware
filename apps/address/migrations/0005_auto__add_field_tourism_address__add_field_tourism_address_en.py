...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tourism.address'
        db.add_column('address_tourism', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Tourism.address_en'
        db.add_column('address_tourism', 'address_en',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Tourism.address'
        db.delete_column('address_tourism', 'address')

        # Deleting field 'Tourism.address_en'
        db.delete_column('address_tourism', 'address_en')
