...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Region.country'
        db.alter_column('address_region', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['address.Country'], null=True))
    def backwards(self, orm):

        # Changing field 'Region.country'
        db.alter_column('address_region', 'country_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['address.Country']))
    models = {
        'address.city': {
