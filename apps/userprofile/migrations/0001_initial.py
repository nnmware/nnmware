...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'userprofile_profile', (
            ...
            ('avatar', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Pic'], null=True, blank=True)),
        ))
    ...
    models = {
        ...
        u'userprofile.emailvalidation': {
            'Meta': {'ordering': "['username', 'created']", 'object_name': 'EmailValidation'},
        ...
        u'userprofile.profile': {
            ...
            'avatar': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Pic']", 'null': 'True', 'blank': 'True'}),
