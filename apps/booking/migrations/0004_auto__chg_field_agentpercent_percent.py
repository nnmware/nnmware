...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AgentPercent.percent'
        db.alter_column('booking_agentpercent', 'percent', self.gf('django.db.models.fields.DecimalField')(max_digits=4, decimal_places=1))
    def backwards(self, orm):

        # Changing field 'AgentPercent.percent'
        db.alter_column('booking_agentpercent', 'percent', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=3))
    models = {
        'address.city': {
