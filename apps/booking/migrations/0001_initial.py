...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('booking_hotel', (
            ...
            ('register_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 3, 29, 0, 0))),
        ...
        db.create_table('booking_review', (
            ...
            ('food', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('service', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('purity', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('transport', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('prices', self.gf('django.db.models.fields.FloatField')(default=0.0)),
        ))
    ...
    models = {
        ...
        'booking.hotel': {
            ...
            'register_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 29, 0, 0)'}),
        ...
        'booking.review': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 29, 0, 0)'}),
            'food': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'hotel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['booking.Hotel']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'prices': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'purity': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'review': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'service': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'transport': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'booking.room': {
