...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RequestAddHotel.ip'
        db.add_column('booking_requestaddhotel', 'ip',
                      self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True),
                      keep_default=False)

        # Adding field 'RequestAddHotel.user_agent'
        db.add_column('booking_requestaddhotel', 'user_agent',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'RequestAddHotel.ip'
        db.delete_column('booking_requestaddhotel', 'ip')

        # Deleting field 'RequestAddHotel.user_agent'
        db.delete_column('booking_requestaddhotel', 'user_agent')
