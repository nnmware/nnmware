    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admins', models.ManyToManyField(blank=True, related_name='news_newscategory_adm', to=settings.AUTH_USER_MODEL, verbose_name='Category Admins')),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='news.NewsCategory', verbose_name='Parent')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='news',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, to='news.NewsCategory', verbose_name='Category'),
        ),
        migrations.AddField(
            model_name='news',
            name='region',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='news_reg', to='address.Region', verbose_name='Region'),
        ),
        migrations.AddField(
            model_name='news',
            name='user',
