...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.date'
        db.alter_column('money_account', 'date', self.gf('django.db.models.fields.DateField')())

        # Changing field 'Account.date_billed'
        db.alter_column('money_account', 'date_billed', self.gf('django.db.models.fields.DateField')())
    def backwards(self, orm):

        # Changing field 'Account.date'
        db.alter_column('money_account', 'date', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Account.date_billed'
        db.alter_column('money_account', 'date_billed', self.gf('django.db.models.fields.DateTimeField')())
    models = {
        'address.country': {
        ...
        'money.account': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 2, 0, 0)'}),
            'date_billed': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 2, 0, 0)'}),
