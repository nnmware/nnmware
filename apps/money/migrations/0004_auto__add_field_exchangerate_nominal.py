...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExchangeRate.nominal'
        db.add_column('money_exchangerate', 'nominal',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ExchangeRate.nominal'
        db.delete_column('money_exchangerate', 'nominal')
