...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('social_usersocialauth', (
            ...
            ('extra_data', self.gf('nnmware.core.fields.JSONField')(default='{}')),
        ))
        db.send_create_signal('social', ['UserSocialAuth'])

        # Adding unique constraint on 'UserSocialAuth', fields ['provider', 'uid']
        db.create_unique('social_usersocialauth', ['provider', 'uid'])

        # Adding model 'Nonce'
        db.create_table('social_nonce', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('social', ['Nonce'])

        # Adding model 'Association'
        db.create_table('social_association', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('server_url', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ...
        db.send_create_signal('social', ['Association'])


    def backwards(self, orm):
        # Removing unique constraint on 'UserSocialAuth', fields ['provider', 'uid']
        db.delete_unique('social_usersocialauth', ['provider', 'uid'])

        # Deleting model 'UserSocialAuth'
        db.delete_table('social_usersocialauth')

        # Deleting model 'Nonce'
        db.delete_table('social_nonce')

        # Deleting model 'Association'
        db.delete_table('social_association')
    ...
    models = {
        ...
        'social.usersocialauth': {
            ...
            'extra_data': ('nnmware.core.fields.JSONField', [], {'default': "'{}'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
