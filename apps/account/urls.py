...
urlpatterns = patterns(
    ...
    # 'account/account/registration_done.html'},name='signup_complete'),
    ...
    #        {'template': 'account/account/email_validation_processed.html'},
    #        name='email_validation_processed'),
    url(r'^password/reset/$', 'django.contrib.auth.views.password_reset', {'template_name': 'profile/account/password_reset.html',
             'email_template_name': 'account/email/password_reset_email.txt'},
        name='password_reset'),
    url(r'^password/reset/done/$',
        'django.contrib.auth.views.password_reset_done',
            {'template_name': 'profile/account/password_reset_done.html'},
        name='password_reset_done'),
    url(r'^reset/(?P<uidb36>[0-9A-Za-z]+)-(?P<token>.+)/$',
        'django.contrib.auth.views.password_reset_confirm',
            {'template_name': 'profile/account/password_reset_confirm.html'},
